...
let campos = ["null","nome", "posicao", "escritorio", "salario"];
...
//columns[2].data = "Teste";


/*
i=0;
while(i <= campos.length){    
    //console.log(columns[i]["data"] + " receberá " +campos[i]);
    //console.log(i);
    columns.data.push(campos[i]);
    //columns.push("teste novoa");
    i++;
}
*/
...
//console.log("Aqui tem que ficar posicao ->" + columns[0]["data"]);
